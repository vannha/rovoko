(function( $ ) {
    ...
    $( document ).ready( function() {
        ...
        rovoko_vcRow();
        rovoko_inlineCss();
        rovoko_ajax_pagination();
        rovoko_woo_filters();
        rovoko_wc_single_product_gallery();
        rovoko_wooscp_change_text();
        // WooCommerce
        rovoko_quantity_plus_minus();
        rovoko_quantity_plus_minus_action();
        rovoko_remove_cart_actions();

        rovoko_svg_color();
        rovoko_smooth_scroll();

        rovoko_tabs();
        rovoko_post_count_like();
    });
	// On Load
	$(window).load(function() {
		...
		rovoko_page_loading();
        rovoko_vcRow();
        rovoko_woo_price_filter_add_data_title();
        rovoko_wooscp_change_text();
        rovoko_masonry_filter();
        rovoko_vc_animation_callback();

        rovoko_tabs();
        rovoko_project_gallery_isotope();
    });
	// On scroll
	...
	*/
	 ...
	 * Open Mobile Menu
    */
    function rovoko_open_mobile_menu(){
    	'use strict';
    ...
    */
    ...
    function rovoko_ajax_pagination(){
        'use strict';
    ...
    function rovoko_init_price_filter() {
        "use strict";
     ...
     * Add data title
    */
    function rovoko_woo_price_filter_add_data_title(){
        "use strict";
    ...
    */
    ...
    function rovoko_quantity_plus_minus(){
        "use strict";
        $( ".single-product .quantity input" ).wrap( "<div class='ef5-quantity'></div>" );
        $('<span class="quantity-button quantity-down"></span>').insertAfter('.single-product .quantity input');
        $('<span class="quantity-button quantity-up"></span>').insertAfter('.single-product .quantity input');
    }
    function rovoko_ajax_quantity_plus_minus(){
        "use strict";
        $('<span class="quantity-button quantity-down"></span>').insertBefore('.single-product .quantity input');
        $('<span class="quantity-button quantity-up"></span>').insertAfter('.single-product .quantity input');
    }
    function rovoko_quantity_plus_minus_action(){
        "use strict";
    ...
    function rovoko_wc_single_product_gallery(){
        'use strict';
            ...
            $('.wc-gallery-sync').each(function() {
                ...
                if($(this).hasClass('thumbnail_v')){
                    $(this).flexslider({
                        ...
                        itemMargin     : itemMargin, // need it to fix transform item
                        move           : 3,
     ...
     * Cart Page
    */
    function rovoko_table_move_column(table, selected ,from, to, remove, colspan, colspan_value) {
        "use strict";
    ...
    function rovoko_remove_cart_actions(){
        "use strict";
        /**
    ...
    // Woo Smart Compare 
    function rovoko_wooscp_change_text(){
        'use strict';
    ...
    /* Masonry */
    function rovoko_masonry_filter(){
        "use strict";
    ...
    /* VC Animation */
    function rovoko_vc_animation_callback(){
        "use strict";
     ...
     * @since 1.0.0
     */
    function rovoko_post_count_like() {
        'use strict';
        $('.ef5-like').on('click', function (event) {
            /* get post id. */
            var bt_like = $(this);
    ...
    /*
    * isotope in single Project 
    */
    function rovoko_project_gallery_isotope(){
        "use strict";
        if (typeof $.fn.masonry != 'undefined') {
            $('.single-project .ef5-content-project .gallery').isotope({
                itemSelector: '.single-project .ef5-content-project .gallery .gallery-item',
            });
        }
    }
})( jQuery );
...
function rovoko_btt_start() {
    ...
    rovoko_btt_btn(scrollPercentRounded);
};

function rovoko_btt_btn(i) {
    "use strict";
    var prec = i * 3.6;
    jQuery('#ef5-btt-prec').html(i + '%');
    var borderColor = rovoko_ajax_opts.primary_color,
        borderActiveColor = rovoko_ajax_opts.accent_color;
    if (prec <= 180) {
