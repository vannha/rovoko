...
$args =  array(
    ...
    'menu_class'     => rovoko_header_menu_class(),
    'link_before'	 => '<span class="menu-title">',
    'link_after'	 => '</span>',	
    'walker'         => ($megamenu && class_exists( 'EF5Systems_MegaMenu_Walker' )) ? new EF5Systems_MegaMenu_Walker : new Rovoko_Main_Menu_Walker,
    'fallback_cb' =>   'rovoko_header_menu_fallback'
);
wp_nav_menu($args);
