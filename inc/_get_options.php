 ...
 * @return string
 */
function rovoko_get_theme_opt_name()
{
    return apply_filters('rovoko_theme_opt_name', 'ef5_theme_options');
}
 ...
 * @return mixed
 */
function rovoko_get_theme_opt($opt_id, $default = false){
 ...
 * @return string
 */
function rovoko_get_page_opt_name()
{
    return apply_filters('rovoko_page_opt_name', 'ef5_page_options');
}
/**
 * Get theme option based on its id.
 *
 ...
 * @return mixed
 */
function rovoko_get_page_opt($opt_id, $default = false)
{
    $page_opt_name = rovoko_get_page_opt_name();
 ...
 * @return mixed
 */
function rovoko_get_opts($opt_id, $default = false){
    $theme_opt = rovoko_get_theme_opt($opt_id, $default);
    $page_opt  = rovoko_get_page_opt($opt_id, $theme_opt);
 ...
 * @return bool|mixed
 */
function rovoko_get_post_format_value($post_format_key, $default = '')
{
    global $post;
