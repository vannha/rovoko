 ...
 * add filter bar
*/
//add_action('rovoko_woocommerce_before_shop_loop','rovoko_woocommerce_filter_bar');
function rovoko_woocommerce_filter_bar(){
    $attribute_array = [];
...
?>
	<div class="ef5-woo-filters row">
		<?php 
            ...
            rovoko_woo_filtered_list($filtered_args);

		    do_action('rovoko_woocommerce_filter_orderby');
            ...
            // Rating Filter
            $filter_rating_args = [
                'title'           => esc_html__('Average Rating','rovoko'),
            ];
            the_widget(
            ...
            $filter_by_price_args = [
                'title'           => esc_html__('Filter by Price','rovoko'),
            ];
            the_widget(
