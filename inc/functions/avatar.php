 ...
 * add_action('switch_theme', 'rovoko_update_avatar');
 *
*/
 ...
 * add_filter( 'avatar_defaults', 'rovoko_default_avatar' );
 */
function rovoko_default_avatar( $avatar_defaults ) {
	$ef5_avatar = get_template_directory_uri() . '/assets/images/avatar.png';
 ...
 *
 */
if(!function_exists('rovoko_get_avatar_size')){
	function rovoko_get_avatar_size() {
		return rovoko_configs('cmt_avatar_size');
	}
}
 ...
 * add_filter( 'get_avatar' , 'rovoko_custom_avatar' , 1 , 6 );
 * 
*/
if(!function_exists('rovoko_custom_avatar')){
	function rovoko_custom_avatar($avatar, $id_or_email, $size, $default, $alt, $args) {
