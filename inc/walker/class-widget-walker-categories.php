...
class Rovoko_Categories_Walker extends Walker_Category {
    /**
    ...
    public function start_el( &$output, $category, $depth = 0, $args = array(), $id = 0 ) {
        ...
        if ( ! empty( $args['feed_image'] ) || ! empty( $args['feed'] ) ) {
            ...
            if ( empty( $args['feed'] ) ) {
                $alt = ' alt="' . sprintf(__( 'Feed for all posts filed under %s','rovoko' ), $cat_name ) . '"';
            } else {
                $alt = ' alt="' . $args['feed'] . '"';
                $name = $args['feed'];
